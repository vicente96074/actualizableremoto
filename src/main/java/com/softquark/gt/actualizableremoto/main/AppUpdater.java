...
public class AppUpdater {
    ...
    private static final String UPDATE_CONFIG_URL = "https://github.com/vicente96074/actualizableremoto/releases/latest/update/config.json";
    private static final String APP_JAR_URL = "https://github.com/vicente96074/actualizableremoto/releases/latest/update/app.jar";
